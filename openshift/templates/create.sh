...
#oc process -f ./configmap.yaml  KEYCLOAK_REALM=${KEYCLOAK_REALM} KEYCLOAK_URL=${KEYCLOAK_URL} JWT_ISSUER_URI=${JWT_ISSUER_URI} ENV_NAME=${ENV_NAME}  JWKS_URL=${JWKS_URL}| oc apply -f -
